...
| Risk Per Trade | 5-Trade Losing Streak | Impact on $100k Account |
|---|---|---|
...
|---|---|
| 14-day ADR | 85 pips |
| Today's range so far | 67 pips |
| Daily range consumed | 78.8% |
| Verdict | High-risk entry — wait or skip |
...
| Week | Trades | Avg Risk | Win Rate | Net P&L |
|---|---|---|---|---|
| Week 1 | 8 trades | 0.35% | 55% | +1.4% |
| Week 2 | 7 trades | 0.35% | 57% | +1.2% |
| Week 3 | 10 trades | 0.35% | 50% | +0.7% |
| Week 4 | 8 trades | 0.35% | 62% | +1.8% |
| **Month Total** | **33 trades** | — | **56%** | **+5.1%** |
